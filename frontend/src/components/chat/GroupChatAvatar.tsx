...
const GroupChatAvatar = ({ participants, type }: GroupChatAvatarProps) => {
    ...
    return (
        ...
        *:data-[slot=avatar]:ring-2">
            ...
            {/* nếu nhiều hơn 4 thành viên render dấu ... */}
            {participants.length > limit && (
                <div className="flex items-center justify-center size-8 rounded-full bg-muted ring-2 ring-background text-muted-foreground">
